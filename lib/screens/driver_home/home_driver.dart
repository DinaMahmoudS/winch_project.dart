...
class _DriverHomeState extends State<DriverHome> {
    ...
    return Scaffold(
      body: Container(
        child: Column(
          children: <Widget>[
            Expanded(
              child: StreamBuilder<List<RequstWinsh>>(
                stream: readDriver(),
  ...
  Stream<List<RequstWinsh>> readDriver() => FirebaseFirestore.instance
      .collection("requset winsh")
      .snapshots()
      .map((event) =>
          event.docs.map((e) => RequstWinsh.fromJson(e.data())).toList());
